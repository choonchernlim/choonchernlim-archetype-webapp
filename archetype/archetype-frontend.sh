...
cp archetype/frontend/src/js/chuck-norris/api/index.js ${FRONTEND_PATH}/src/js/chuck-norris/api/index.js
cp archetype/frontend/src/js/home/components/Home.js ${FRONTEND_PATH}/src/js/home/components/Home.js
